...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('✪ ᴍᴀɪɴ ɢʀᴏᴜᴘ', url="https://t.me/+nDTaoJGRKJcxYmZl"),
            InlineKeyboardButton('⌬ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ', url='https://t.me/TG_BOTS_UPDATE/91')
        ],[
